...
export type Database = {
  public: {
    Tables: {
      ...
      notifications: {
        Row: {
          id: string;
          customer_id: string;
          type: 'order' | 'appointment' | 'promo' | 'account' | 'system';
          title: string;
          body: string | null;
          link: string | null;
          read_at: string | null;
      ...
      // Tokens only — no PAN, no CVV. See the PCI note in migration 0009.
      saved_cards: {
        Row: {
          id: string;
          customer_id: string;
      ...
      product_reviews: {
        ...
        Insert: {
          ...
          id?: string;
          updated_at?: string | null;
          // Set by the product_reviews_verified trigger; never supply it.
          verified_purchase?: boolean;
          product_id: string;
          rating: number;
          status?: Database['public']['Enums']['review_status'];
    ...
    Enums: {
      appt_status: 'pending' | 'confirmed' | 'rescheduled' | 'cancelled' | 'completed';
