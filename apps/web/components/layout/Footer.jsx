      ...
      <div className="section-container">
        <div className="mb-10 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-6 lg:gap-10">
          <div className="space-y-4 lg:col-span-2">
            <div className="inline-flex">
              <Image src="/images/footer-img.png" alt="Optex Opticians" width={165} height={60} className="block h-auto w-[165px] object-contain" />
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="group flex items-center space-x-3 text-gray-300">
                ...
                <span className="text-[12.5px] font-semibold leading-tight">Nairobi CBD, Kenya</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-[13.5px] font-medium text-gray-400">
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/category/eyeglasses" className="hover:text-[#E53935]">Eyeglasses</Link>
              </li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/category/sunglasses" className="hover:text-[#E53935]">Sunglasses</Link>
              </li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/category/contact-lenses" className="hover:text-[#E53935]">Contact Lenses</Link>
              </li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/category/kids" className="hover:text-[#E53935]">Kids Eyewear</Link>
              </li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/shop" className="hover:text-[#E53935]">All Products</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-[13.5px] font-medium text-gray-400">
              <li className="cursor-pointer transition-colors hover:text-[#E53935]">Eye Examination</li>
              <li className="cursor-pointer transition-colors hover:text-[#E53935]">Frame Fitting</li>
              <li className="cursor-pointer transition-colors hover:text-[#E53935]">Lens Replacement</li>
              <li className="cursor-pointer transition-colors hover:text-[#E53935]">Repairs</li>
              <li className="cursor-pointer transition-colors hover:text-[#E53935]">Virtual Try-On</li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/branch-locator" className="hover:text-[#E53935]">Find a Store</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-[13.5px] font-medium text-gray-400">
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/contact" className="hover:text-[#E53935]">Contact Us</Link>
              </li>
              <li className="cursor-pointer transition-colors hover:text-[#E53935]">FAQs</li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/returns" className="hover:text-[#E53935]">Returns Policy</Link>
              </li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/delivery" className="hover:text-[#E53935]">Delivery Policy</Link>
              </li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/warranty" className="hover:text-[#E53935]">Warranty Policy</Link>
              </li>
              <li className="transition-colors hover:text-[#E53935]">
                <Link href="/privacy" className="hover:text-[#E53935]">Privacy Policy</Link>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-8 rounded-[25px] border border-gray-800/50 bg-[#1A1A1A] p-5 sm:p-6 md:p-8">
          <div className="flex flex-col items-stretch justify-between gap-6 lg:flex-row lg:items-center">
            <div className="space-y-2 text-center lg:text-left">
              <h3 className="text-[20px] font-bold tracking-tight text-white md:text-[24px]">Subscribe to Our Newsletter</h3>
        ...
        <div className="flex flex-col items-center justify-between gap-4 border-t border-gray-800 py-6 text-center md:flex-row md:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 md:justify-end">
            <div className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-gray-800 text-[10px] font-bold text-gray-400 transition-all hover:bg-white hover:text-black">FB</div>
            <div className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-gray-800 text-[10px] font-bold text-gray-400 transition-all hover:bg-white hover:text-black">IG</div>
            <div className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-gray-800 text-[10px] font-bold text-gray-400 transition-all hover:bg-white hover:text-black">TW</div>
            <div className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-gray-800 text-[10px] font-bold text-gray-400 transition-all hover:bg-white hover:text-black">LN</div>
          </div>
        </div>
      </div>
    </footer>
