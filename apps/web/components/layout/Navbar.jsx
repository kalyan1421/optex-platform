...
const ChevronDown = () => (
  <svg className="w-[14px] h-[8px] flex-shrink-0" fill="none" viewBox="0 0 14 8">
      ...
      <div className="mx-auto flex h-full w-full max-w-[1440px] items-center gap-4 px-4 sm:px-10 lg:justify-between lg:gap-0 lg:px-[100px]">
                ...
                >
                  ...
                  {isCatOpen && (
                    <div className="absolute top-full left-1/2 -translate-x-1/2 pt-3 z-50">
                      <div className="w-52 rounded-[18px] bg-white shadow-2xl border border-gray-100 py-2">
                        {CATEGORIES.map((cat) => (
                          <Link
                            key={cat.slug}
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-[20px] lg:ml-0">
          <button
            aria-label="Search"
            onClick={openSearch}
            className="p-1 hover:opacity-80 transition-opacity sm:hidden"
          >
            <SearchNavIcon />
          </button>
          <Link href="/cart" aria-label="Cart" className="relative p-1 sm:p-0 hover:opacity-80 transition-opacity">
            <CartIcon />
            {cartCount > 0 && (
          ...
          <Link href="/profile" aria-label="Profile" className="p-1 sm:p-0 hover:opacity-80 transition-opacity">
            <UserIcon />
          </Link>
