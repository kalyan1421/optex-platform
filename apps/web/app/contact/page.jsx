    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative flex w-full flex-col items-end justify-center overflow-hidden bg-[#E53935] lg:h-[354px] lg:pr-[100px]">
        ...
        <div className="relative z-10 flex flex-col items-end lg:h-[152px] lg:w-[511px] lg:gap-[14px]">
          ...
          >
            Have questions or need assistance? Our dedicated team is here to help you find the perfect vision solution.
          </p>
        </div>
      </section>

      {/* Main Content Area */}
      <main className="mx-auto flex w-full max-w-[1440px] flex-col px-6 lg:px-[100px] lg:pt-[80px] lg:pb-[80px]">
        <div className="flex flex-col lg:flex-row lg:w-[1240px] gap-12 lg:gap-[80px]">
          
          {/* Left Column: Contact Form */}
          <div data-aos="fade-right" className="flex shrink-0 flex-col bg-white lg:h-[639.6px] lg:w-[533.6px] lg:gap-[32px] lg:rounded-[32px] lg:p-[48px]" style={{ border: '0.8px solid #F3F4F6', boxShadow: '0px 25px 50px -12px rgba(0,0,0,0.25)' }}>
            <h2 
              className="text-[#000000] lg:h-[48px] lg:w-[436px]"
              style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '32px', lineHeight: '48px' }}
            >
              Send us a message
            </h2>
            ...
            {submitted ? (
              <div className="text-center py-8 space-y-4">
                ...
                <p className="text-[14px] text-gray-500">Thank you for reaching out. Our team will get back to you within 24 hours.</p>
                <button
              ...
              <form onSubmit={handleSubmit} className="flex flex-col lg:h-[462.8px] lg:w-[436px] lg:gap-[24px]">
                {formError && (
                  <div className="bg-red-50 border border-red-100 text-red-600 text-[13px] px-4 py-3 rounded-[12px]">
                    {formError}
                  </div>
                )}
                
                {/* Row 1: Name & Email */}
                <div className="flex flex-col lg:flex-row lg:h-[78.6px] lg:w-[436px] lg:gap-[24px] gap-6">
                  {/* Full Name */}
                  <div className="flex flex-col lg:h-[78.6px] lg:w-[206px] lg:gap-[8px]">
                    ...
                    <input
                      ...
                      required
                      className="w-full bg-white outline-none placeholder:text-[#0A0A0A80] focus:border-[#2A3182] transition-colors lg:h-[49.6px] lg:px-[16px] lg:py-[12px]"
                      style={{ borderRadius: '14px', border: '0.8px solid #E5E7EB', fontFamily: 'Inter, sans-serif', fontSize: '16px' }}
                    />
                  </div>
                  {/* Email */}
                  <div className="flex flex-col lg:h-[78.6px] lg:w-[206px] lg:gap-[8px]">
                ...
                <div className="flex flex-col lg:h-[174.6px] lg:w-[436px] lg:gap-[8px]">
                  ...
                  <textarea
                    ...
                    required
                    className="w-full bg-white outline-none placeholder:text-[#0A0A0A80] focus:border-[#2A3182] transition-colors resize-none lg:h-[145.6px] lg:px-[16px] lg:py-[12px]"
                    style={{ borderRadius: '14px', border: '0.8px solid #E5E7EB', fontFamily: 'Inter, sans-serif', fontSize: '16px' }}
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex shrink-0 items-center justify-center text-white bg-[#2E3192] transition-opacity hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed lg:h-[59px] lg:w-[436px] lg:py-[16px] active:scale-95"
                  style={{ borderRadius: '14px' }}
                >
                  <span style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '18px', lineHeight: '27px' }}>
          ...
          <div data-aos="fade-left" className="flex shrink-0 flex-col lg:w-[533.6px] lg:pt-[40px]">
            ...
            <p 
              className="text-[#717182] lg:h-[58.5px] lg:w-[533.6px] lg:mt-[16px]"
              style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400, fontSize: '18px', lineHeight: '29.25px' }}
            >
              Visit our showroom in New Delhi or contact us through any of our channels. We're always available to help.
            </p>
            ...
            <div className="flex flex-col lg:mt-[32px] lg:h-[450.4px] lg:w-[533.6px] lg:gap-[24px]">
              ...
              >
                <div className="flex items-center justify-center lg:h-[45px] lg:w-[33px] text-[24px]">
                  📍
                </div>
                <div className="flex flex-col lg:h-[45px]">
                  ...
                  <p 
                    ...
                    style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400, fontSize: '14px', lineHeight: '21px' }}
                  >
