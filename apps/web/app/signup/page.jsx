...
const EyeOffIcon = () => (
  <svg className="w-5 h-5 cursor-pointer text-gray-400 transition-colors hover:text-gray-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#f8f9fa] px-4 py-10 sm:px-6 sm:py-12">
      <div className="mb-6 flex flex-col items-center text-center">
        <Link href="/">
          <Image src="/images/Logo.png" alt="Optex" width={120} height={60} className="mb-4 h-[60px] w-auto object-contain" />
        </Link>
      ...
      <div className="w-full max-w-[480px] rounded-[28px] bg-white p-6 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.08)] sm:rounded-[32px] sm:p-8 lg:p-10">
        <div className="mb-8 text-center">
          ...
          <p className="px-4 text-[13px] font-medium text-gray-500">Join our vision community for personalized eye care.</p>
        </div>
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <div>
            <label className="mb-2 block text-[13px] font-bold text-[#1a1a1a]">Confirm Password</label>
            <div className="relative flex items-center">
              <div className="absolute left-4"><HistoryIcon /></div>
              <input
                ...
                className="w-full rounded-2xl border border-gray-100 bg-[#f8f9fa] py-3.5 pl-12 pr-12 text-[14px] tracking-widest text-gray-800 outline-none transition-colors placeholder:text-gray-400 focus:border-[#2A3182] focus:bg-white"
              />
              <button type="button" className="absolute right-4" onClick={() => setShowConfirmPassword(!showConfirmPassword)} aria-label={showConfirmPassword ? 'Hide' : 'Show'}>
          ...
          <div className="mb-2 mt-1 flex items-start gap-3">
            ...
            <p className="text-[12px] font-medium leading-relaxed text-gray-500">
              I agree to the <a href="#terms" className="text-[#2A3182] hover:underline">Terms of Service</a> and <a href="#privacy" className="text-[#2A3182] hover:underline">Privacy Policy</a>.
            </p>
          </div>
          ...
          <button
            ...
            className="w-full rounded-full bg-[#1a1a5c] py-4 text-[15px] font-bold text-white transition-colors hover:bg-[#2A3182] disabled:opacity-60 disabled:cursor-not-allowed"
          >
        ...
        <p className="mt-6 text-center text-[13px] font-medium text-gray-500">
          Already have an account? <Link href="/login" className="font-bold text-[#2A3182] hover:underline">Sign In</Link>
        </p>
