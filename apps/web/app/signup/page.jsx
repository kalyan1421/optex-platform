...
const UserIcon = () => (
  <svg
    className="h-[18px] w-[18px] text-[#767683] lg:h-[16px] lg:w-[16px]"
    fill="none"
    viewBox="0 0 16 16"
...
const MailIcon = () => (
  <svg
    className="h-[18px] w-[18px] text-[#767683] lg:h-[16px] lg:w-[20px]"
    fill="none"
    viewBox="0 0 20 16"
    xmlns="http://www.w3.org/2000/svg"
  >
...
const LockIcon = () => (
  <svg
    className="h-[23.625px] w-[18px] text-[#767683] lg:h-[21px] lg:w-[16px]"
    fill="none"
    viewBox="0 0 16 21"
    xmlns="http://www.w3.org/2000/svg"
  >
...
const EyeOffIcon = () => (
  <svg
    className="h-[22.27px] w-[24.75px] cursor-pointer text-[#767683] transition-colors hover:text-gray-600 lg:h-[20px] lg:w-[22px]"
    fill="none"
    viewBox="0 0 22 20"
    xmlns="http://www.w3.org/2000/svg"
  >
...
const EyeIcon = () => (
  <svg
    className="h-[22.27px] w-[24.75px] cursor-pointer text-[#767683] transition-colors hover:text-gray-600"
    fill="none"
    stroke="currentColor"
    strokeWidth="2"
    viewBox="0 0 24 24"
...
const HistoryIcon = () => (
  <svg
    className="h-[22.5px] w-[22.5px] text-[#767683] lg:h-[20px] lg:w-[20px]"
    fill="none"
    viewBox="0 0 20 20"
    xmlns="http://www.w3.org/2000/svg"
  >
...
const Signup = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-[#F9F9FC] px-[54px] pb-[162px] pt-[95px]">
      ...
      <div
        className="w-full max-w-[504px] rounded-[36px] border-[1.13px] border-[rgba(199,197,212,0.3)] bg-white px-[45px] pb-[45px] pt-[43.88px]"
      ...
      >
        ...
        {success && (
          <div className="mx-auto mb-4 w-full max-w-[411.75px] rounded-xl bg-green-50 px-4 py-3 text-[13px] font-medium text-green-700">
            {success}
          </div>
        )}

        <form
          className="mx-auto flex w-full max-w-[411.75px] flex-col gap-[25.88px]"
        ...
        >
          <div className="flex flex-col gap-[5.4px]">
            ...
            <div className="relative flex h-[56.5px] items-center">
              ...
              <input
                ...
                required
                className="h-full w-full rounded-[11248px] border-[1.13px] border-[#C7C5D4] bg-[#F9F9FC] pl-[54px] pr-[18px] text-[#1A1C1E] outline-none transition-colors focus:border-[#2A3182] focus:bg-white"
                style={{
                  fontFamily: 'Manrope, sans-serif',
                  fontSize: '18px',
                  lineHeight: '100%',
          ...
          <div className="flex flex-col gap-[5.4px]">
            ...
            <div className="relative flex h-[56.5px] items-center">
              ...
              <input
                ...
                required
                minLength={6}
                className="h-full w-full rounded-[11248px] border-[1.13px] border-[#C7C5D4] bg-[#F9F9FC] pl-[54px] pr-[54px] tracking-widest text-[#1A1C1E] outline-none transition-colors focus:border-[#2A3182] focus:bg-white"
                style={{
                  fontFamily: 'Manrope, sans-serif',
                  fontSize: '18px',
                  lineHeight: '100%',
          ...
          <div className="flex items-start gap-[13.5px] pb-[10.13px] pt-[1.13px]">
            <input
              type="checkbox"
              checked={agreed}
              onChange={(e) => setAgreed(e.target.checked)}
              className="relative mt-[2px] flex h-[22.5px] w-[22.5px] shrink-0 cursor-pointer appearance-none items-center justify-center rounded-[18px] border-[1.13px] border-[#C7C5D4] bg-[#F9F9FC] after:absolute after:-mt-[2px] after:h-[10px] after:w-[6px] after:rotate-45 after:border-b-[2px] after:border-r-[2px] after:border-white after:opacity-0 after:content-[''] checked:bg-[#141776] checked:after:opacity-100"
            />
            <p
              className="pt-[2.25px] text-[#1A1C1E]"
              style={{
                fontFamily: 'Manrope, sans-serif',
                fontSize: '15.75px',
                lineHeight: '22.5px',
        ...
        <div className="mt-[34.88px] flex items-center justify-center gap-[4.49px]">
          ...
          <Link
            href="/login"
            className="text-[#141776] underline"
            style={{
              fontFamily: 'Manrope, sans-serif',
              fontSize: '18px',
              lineHeight: '100%',
