...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] pb-10 pt-32 lg:bg-white lg:pt-[50px] lg:pb-[50px]">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col px-6 lg:px-[100px]">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:gap-[32px]">
          ...
          <div className="flex flex-col lg:w-[747px]">
            ...
            <div className="flex flex-col gap-[9px] mb-[36px]">
              <h2 
                ...
                style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '32px', lineHeight: '27px' }}
              >
                Checkout
              </h2>
              <p className="text-[#464652]" style={{ fontFamily: 'Manrope, sans-serif', fontSize: '18px', fontWeight: 400, lineHeight: '27px' }}>
            ...
            <div 
              ...
              style={{
                ...
                boxShadow: activeStep === 1 ? '0px 11.25px 33.75px 0px rgba(45, 50, 140, 0.05)' : 'none',
              }}
            >
              <div className="flex cursor-pointer items-center justify-between p-[20px] lg:p-[27px]" onClick={() => setActiveStep(1)}>
                <div className="flex items-center gap-[18px]">
                  ...
                  <div className="flex items-center gap-[9px]">
                    ...
                    <h3 
                      ...
                      style={{ fontFamily: 'Manrope, sans-serif', fontSize: '18px', fontWeight: 400, lineHeight: '27px' }}
                    >
                      Shipping Address
                    </h3>
                  </div>
                ...
                <div className="px-5 pb-6 lg:px-[36px] lg:pb-[36px]">
                  <div className="border-t border-[#F8FAFC] pt-[27px]">
                    ...
                    <div className="flex flex-col gap-[27px]">
                      {/* Name Row */}
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-[27px]">
                        <div className="flex flex-col gap-[9px]">
                          <label className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', lineHeight: '27px' }}>First Name</label>
                          <input type="text" placeholder="Jane" value={shipping.firstName}
                            onChange={(e) => setShipping(s => ({ ...s, firstName: e.target.value }))}
                            className="w-full h-[56.5px] rounded-[18px] border border-[#C7C5D4] bg-[#F3F3F6] px-[18px] text-[18px] text-[#6B7280] outline-none transition-colors placeholder:text-[#6B7280] focus:border-[#141776] focus:bg-white" 
                            style={{ fontFamily: 'Manrope, sans-serif' }} />
                        </div>
                        <div className="flex flex-col gap-[9px]">
                          <label className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', lineHeight: '27px' }}>Last Name</label>
                      ...
                      {/* Address Row */}
                      <div className="flex flex-col gap-[9px]">
                        <label className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', lineHeight: '27px' }}>Address Line 1</label>
                        <input type="text" placeholder="123 Vision Avenue" value={shipping.address}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-[27px]">
                        <div className="flex flex-col gap-[9px]">
                          <label className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', lineHeight: '27px' }}>City</label>
                          <input type="text" placeholder="London" value={shipping.city}
                            onChange={(e) => setShipping(s => ({ ...s, city: e.target.value }))}
                            className="w-full h-[56.5px] rounded-[18px] border border-[#C7C5D4] bg-[#F3F3F6] px-[18px] text-[18px] text-[#6B7280] outline-none transition-colors placeholder:text-[#6B7280] focus:border-[#141776] focus:bg-white"
                            style={{ fontFamily: 'Manrope, sans-serif' }} />
                        </div>
                        <div className="flex flex-col gap-[9px]">
                          <label className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', lineHeight: '27px' }}>Postcode</label>
                          <input type="text" placeholder="EC1V 2NX" value={shipping.postal}
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-[27px]">
                        <div className="flex flex-col gap-[9px]">
                          <label className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', lineHeight: '27px' }}>Phone Number</label>
                        ...
                        <div className="flex flex-col gap-[9px]">
                          <label className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', lineHeight: '27px' }}>County</label>
                          <select value={shipping.county}
                            onChange={(e) => setShipping(s => ({ ...s, county: e.target.value }))}
                            className="w-full h-[56.5px] rounded-[18px] border border-[#C7C5D4] bg-[#F3F3F6] px-[18px] text-[18px] text-[#6B7280] outline-none transition-colors focus:border-[#141776] focus:bg-white"
                            style={{ fontFamily: 'Manrope, sans-serif' }}>
            ...
            <div 
              ...
              style={{
                borderRadius: '36px',
                border: '1.13px solid #F1F5F9',
                boxShadow: activeStep === 2 ? '0px 11.25px 33.75px 0px rgba(45, 50, 140, 0.05)' : 'none',
              }}
            >
              <div className="flex cursor-pointer items-center justify-between p-[20px] lg:p-[27px]" onClick={() => setActiveStep(2)}>
                <div className="flex items-center gap-[18px]">
                  <div 
                    className={`flex h-[36px] w-[36px] items-center justify-center rounded-full text-[18px]`}
                    style={{ 
              ...
              {activeStep === 2 && (
                <div className="px-5 pb-6 lg:px-[36px] lg:pb-[36px]">
                  <div className="border-t border-[#F8FAFC] pt-[27px]">
                    <div className="flex flex-col gap-[27px]">
                      <label className="flex items-start gap-4 rounded-[18px] border border-[#C7C5D4] bg-[#F3F3F6] p-[18px] cursor-pointer focus-within:border-[#141776] focus-within:bg-white transition-colors">
                        <input type="radio" name="delivery" defaultChecked className="mt-1 accent-[#141776]" readOnly />
                        <div>
                          <p className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif' }}>Standard Delivery — KSH. {formatKesNumber(DELIVERY_FEE_KES)}</p>
                          <p className="text-[14px] text-[#6B7280] mt-0.5" style={{ fontFamily: 'Manrope, sans-serif' }}>2–5 business days within Nairobi; 3–7 days upcountry</p>
                        </div>
                      </label>
                      <div className="pt-[9px]">
            ...
            <div 
              ...
              style={{
                borderRadius: '36px',
                border: '1.13px solid #F1F5F9',
                boxShadow: activeStep === 3 ? '0px 11.25px 33.75px 0px rgba(45, 50, 140, 0.05)' : 'none',
              }}
            >
              <div className="flex cursor-pointer items-center justify-between p-[20px] lg:p-[27px]" onClick={() => setActiveStep(3)}>
                <div className="flex items-center gap-[18px]">
                  <div 
                    className={`flex h-[36px] w-[36px] items-center justify-center rounded-full text-[18px]`}
                    style={{ 
                  ...
                  <div className="border-t border-[#F8FAFC] pt-[27px]">
                    <div className="flex flex-col gap-[18px]">
                      {PAYMENT_METHODS.map((pm) => (
                        <label key={pm.id}
                          className={`flex items-start gap-4 rounded-[18px] border p-[18px] cursor-pointer transition-colors ${paymentMethod === pm.value ? 'border-[#141776] bg-white' : 'border-[#C7C5D4] bg-[#F3F3F6] hover:border-[#141776]'}`}>
                          <input type="radio" name="payment" value={pm.value} checked={paymentMethod === pm.value}
                            onChange={() => setPaymentMethod(pm.value)}
                            className="mt-1 accent-[#141776]" />
                          <div>
                            <p className="text-[18px] text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif' }}>{pm.label}</p>
                            <p className="text-[14px] text-[#6B7280] mt-0.5" style={{ fontFamily: 'Manrope, sans-serif' }}>{pm.description}</p>
                          </div>
                        </label>
                      ))}
                    </div>
          ...
          {/* Order Summary */}
          <div className="w-full flex-shrink-0 lg:flex-1 lg:w-[461px]">
            <div 
              className="sticky top-28 bg-white flex flex-col p-6 sm:p-8 lg:p-[36px]"
              style={{
                borderRadius: '36px',
            ...
            >
              ...
              <div className="flex flex-col gap-[27px]">
                {items.length === 0 ? (
                  ...
                  <div key={`${item.id}-${index}`} className="flex items-start gap-[18px]">
                    <div className="relative h-[90px] w-[90px] flex-shrink-0 rounded-[18px] bg-[#F5F5F5] border-[0.8px] border-[#D4D4D4] p-[0.8px]">
                      <img src={item.image} alt={item.title} className="h-full w-full object-cover mix-blend-multiply rounded-[18px]" />
                      <span className="absolute -top-2 -right-2 bg-[#E53935] text-white w-6 h-6 flex items-center justify-center rounded-[26843500px] text-[12px] font-bold shadow-sm" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        {item.quantity}
                      </span>
                    </div>
                    <div className="flex-1 min-w-0 flex flex-col py-1">
                      <div className="flex justify-between items-start gap-4">
                        <div className="flex flex-col">
                          {item.brand && (
                            <p className="uppercase text-[#E53935]" style={{ fontFamily: 'Arimo, sans-serif', fontWeight: 400, fontSize: '11px', letterSpacing: '1px' }}>
                              {item.brand}
                            </p>
                          )}
                          <h4 className="text-[#000000] line-clamp-2 mt-1" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 600, fontSize: '16px', lineHeight: '22px' }}>
                            {item.title}
                          </h4>
                          {item.variant && (
                            <p className="text-[#717182] mt-1.5" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 400, fontSize: '12px' }}>
                              {item.variant}
                            </p>
                          )}
                        </div>
                        <p className="text-[#2E3192] whitespace-nowrap" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '16px' }}>
              ...
              <div className="space-y-[18px] border-t border-[#F1F5F9] pt-[27px]">
                <div className="flex items-center justify-between">
                  <span className="text-[#464652]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400, fontSize: '18px', lineHeight: '27px' }}>Subtotal</span>
                  <span className="text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400, fontSize: '18px', lineHeight: '27px' }}>KSH. {formatKesNumber(subtotal)}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[#464652]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400, fontSize: '18px', lineHeight: '27px' }}>Shipping</span>
                  <span className="text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400, fontSize: '18px', lineHeight: '27px' }}>{shippingKes === 0 ? 'FREE' : `KSH. ${formatKesNumber(shippingKes)}`}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-[#464652]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400, fontSize: '18px', lineHeight: '27px' }}>Estimated Tax</span>
                  <span className="text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400, fontSize: '18px', lineHeight: '27px' }}>KSH. {formatKesNumber(vat)}</span>
                </div>
              </div>

              <div className="flex items-center justify-between border-t border-[#F1F5F9] pt-[27px]">
                <span className="text-[#141776]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 700, fontSize: '27px', lineHeight: '37.8px' }}>Total</span>
                <div className="text-[#141776] flex items-baseline gap-[6px]" style={{ fontFamily: 'Manrope, sans-serif' }}>
                  <span style={{ fontWeight: 700, fontSize: '18px', lineHeight: '37.8px' }}>KSH.</span>
                  <span style={{ fontWeight: 700, fontSize: '27px', lineHeight: '37.8px' }}>{formatKesNumber(total)}</span>
                </div>
              </div>
              ...
              <button
                ...
                className="flex w-full h-[78px] items-center justify-center gap-[9px] rounded-[11248px] bg-[#B51A13] text-white transition-colors hover:bg-red-800 disabled:opacity-60 disabled:cursor-not-allowed"
                style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 400, fontSize: '20.25px', lineHeight: '31.5px' }}
              >
              ...
              <p className="px-4 text-center text-[#464652]" style={{ fontFamily: 'Manrope, sans-serif', fontWeight: 500, fontSize: '13.5px', lineHeight: '16.2px' }}>
                By placing your order, you agree to our <a href="#terms" className="underline decoration-solid hover:text-gray-800" style={{ lineHeight: '100%' }}>Terms of Service</a> and <a href="#privacy" className="underline decoration-solid hover:text-gray-800" style={{ lineHeight: '100%' }}>Privacy Policy</a>.
              </p>
            </div>
          </div>
        </div>
